 ...
 *
 * The diff is a precise statement of what the system changed. Read it, answer
 * for the new type in ROLL_TYPE_FAMILIES in scripts/core/roll-parse.js — with
 * `null` if it should never animate — and commit the snapshot in the same
 * commit as the fix.
 */
